    ...
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-primary">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="KPP_Asal">KPP Asal</label>
                    <div class="col-md-6">
                        <input value="<?= set_value('KPP_Asal', $user['KPP_Asal']); ?>" type="text" id="KPP_Asal" name="KPP_Asal" class="form-control" placeholder="KPP Asal">
                        <?= form_error('KPP_Asal', '<span class="text-danger small">', '</span>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="custom-control custom-radio">
                            <input <?= $user['role'] == 'user' ? 'checked' : ''; ?> <?= set_radio('role', 'user'); ?> value="user" type="radio" id="user" name="role" class="custom-control-input">
