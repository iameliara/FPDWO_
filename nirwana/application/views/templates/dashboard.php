...
<head>
    ...
    <title><?= $title; ?> | N I R W A N A</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">N I R W A N A</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('usulan_penilaian'); ?>">
                    <i class="fas fa-fw fa-building"></i>
                    <span>Usulan Penilaian</span>
                </a>
            </li>
            <?php if (is_admin()) : ?>
                <!-- Nav Item - Dashboard -->
                <li class="nav-item">
                    <a class="nav-link pb-0" href="<?= base_url('tindak_lanjut_penilaian'); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseMaster" aria-expanded="true" aria-controls="collapseMaster">
                        ...
                        <span>Ref. Tambah Data</span>
                    </a>
                    <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-light py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Master Data:</h6>
                            <a class="collapse-item" href="<?= base_url('ref/Ref_jenis_penilaian'); ?>">Jenis Penilaian</a>
                            <a class="collapse-item" href="<?= base_url('ref/Ref_objek_penilaian'); ?>">Objek Penilaian</a>
                            <a class="collapse-item" href="<?= base_url('ref/Ref_pejabat_penilaian'); ?>">Daftar Pejabat Penilai</a>
                        </div>
                    </div>
                </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Monitorning Pengawasan Penilaian &bull; by <?= anchor('https://www.instagram.com/akadlan/', 'akadlan'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- MEMATIKAN ICON + YANG MEMBUKA DATA TAMBAHAN DATA TABLE -->
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function cb(start, end) {
                $('#tangal').val(start.format('MM-DD-YYYY') + ' - ' + end.format('MM-DD-YYYY'));
            }
