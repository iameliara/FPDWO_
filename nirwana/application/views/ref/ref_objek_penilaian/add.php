                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('objek_penilaian'); ?>" name="objek_penilaian" id="objek_penilaian" type="text" class="form-control" placeholder="" onkeyup="this.value = this.value.toUpperCase()">
                        </div>
